...
class Program
{
    static Hashtable GetHashtable()
    {
        ...
        hashtable.Add("70000", "Ratchaburi");
    ...
    static void Main()
    {
        ...
        if (val == "18000")
        {
            string value1 = (string)hashtable["18000"];
        ...
        if (val == "93000")
        {
            string value1 = (string)hashtable["93000"];
            Console.WriteLine(value1);
        }
        if (val == "40000")
        {
        ...
        if (val == "70000")
        {
            string value1 = (string)hashtable["70000"];
            Console.WriteLine(value1);
        }
        if (val == "36000")
        {
